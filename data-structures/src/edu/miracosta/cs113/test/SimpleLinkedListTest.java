...
import edu.miracosta.cs113.dataStructures.SimpleLinkedList;

public class SimpleLinkedListTest
{

	private SimpleLinkedList<Integer> intList;
	private SimpleLinkedList<String> stringList;
	private SimpleLinkedList<Double> emptyList;

	@Before
	public void setUp() throws Exception
	{
		intList = new SimpleLinkedList<>();
